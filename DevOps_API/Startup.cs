...
using System.Linq;
using System.Text;
using DevOps_API.Configuration;
using DevOps_API.Middleware;
using DevOps_API.Services;
using DevOps_API.SwaggerExamples;
...
using DevOps_API.Models.DB;
using Microsoft.EntityFrameworkCore;

namespace DevOps_API
{
    /// <summary>
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PlacesDBContext>
                (options => options.UseSqlServer(Configuration.GetConnectionString("db_places")));
